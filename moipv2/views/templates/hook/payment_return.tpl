...
*}		
		...
		{if $moip_status == 'CANCELLED'}
			...
			<p>
				<div class="reorder">
					<a href="{$link->getPageLink('order', true, NULL, "submitReorder=&id_order={{$id_order|escape:'htmlall':'UTF-8'}}")|escape:'htmlall':'UTF-8'}" class="button btn btn-default button-medium "><span>{l s='Refazer pedido' mod='moipv2'}<i class="icon-chevron-right right"></i></span></a>
				</div>
			</p>
