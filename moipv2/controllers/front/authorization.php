    ...
    public function initContent()
    {
        ...
        if (isset($moip_order->id)) {
            ...
            if ($paymentMethod == "BOLETO") {
                ...
                $message  = "Link para 2ª via: " . (string) $PAY_MOIP->_links->payBoleto->printHref;
                ...
                $message  = "Link para o pagamento: " . (string) $PAY_MOIP->_links->payOnlineBankDebitItau->redirectHref;
                ...
                if (!$PAY_MOIP->status) {
                    ...
                    $this->module->validateOrder((int) $cart->id, Configuration::get('MOIPV2_STATUS_3'), $total, "Cartão de Crédito", NULL, $mailVars, (int) $currency->id, false, $customer->secure_key);
