			...
			'form' => array(
				...
				'input' => array(
					...
					array(
						'type' => 'select',
						'lang' => true,
						'label' => $this->l('Tipo de recebimento'),
					...
					array(
						'type' => 'hidden',
						'label' => $this->l('Token de Retorno - Ambiente de Produção'),
						'name' => 'MOIPV2_TOKEN_WEBHOOKS_PROD',
						'desc' => 'Será preenchido após autorizar o modulo',
						'readonly' => true
					),
					array(
					...
					array(
						'type' => 'hidden',
						'label' => $this->l('Token de Retorno - Ambiente SandBox'),
						'name' => 'MOIPV2_TOKEN_WEBHOOKS_DEV',
						'desc' => 'Será preenchido após autorizar o modulo',
						'readonly' => true
					)
				),
